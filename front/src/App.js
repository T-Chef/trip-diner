          ...
          element={
            <Layout user={user} setUser={setUser}>
              <Routes>
                ...
                <Route
                  path="/like/posts"
                  element={<Likeposts userId={user?.user_id} />}
                />
                <Route
                  path="/like/places"
                  element={<Likeplaces userId={user?.user_id} />}
                />
                ...
                <Route
                  path="/trip/result"
                  element={<AIScheduleResult user={user} />}
                />
                <Route path="/trip/summary" element={<AIScheduleSummary />} />

                <Route
                  path="/schedule"
                  element={<Navigate to="/trip" replace />}
                />
                <Route
                ...
                <Route
                  path="/city"
                  element={<CityMain user={user} setUser={setUser} />}
                />
                <Route
                  path="/place/:id"
                  element={<PlaceDetail user={user} setUser={setUser} />}
                />
                <Route
                  path="/event/:id"
                  element={<EventDetail user={user} setUser={setUser} />}
                />
